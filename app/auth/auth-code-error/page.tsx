...
function AuthCodeErrorFallback() {
  return (
    <div className="w-full max-w-md space-y-6 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 shadow-2xl backdrop-blur-sm animate-pulse">
      <div className="h-10 w-10 mx-auto rounded-full bg-zinc-700" />
      <div className="h-6 w-3/4 mx-auto rounded bg-zinc-700" />
